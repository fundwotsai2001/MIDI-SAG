...
if __name__ == '__main__':
    ...
    midi_base_dir = "/data/home/fundwotsai/MIDI-SAG-Draft/MuseControlLite_song_generation/MIR-1K/UndividedWavfile_vocal"
    
    # Beat times directory (from SingNet or other beat detection)
    # Each song subdirectory should contain a beat_times.txt file
    beat_base_dir = "/data/home/fundwotsai/MIDI-SAG-Draft/MuseControlLite_song_generation/MIR-1K/UndividedWavfile_vocal_beat"
    ...
    output_base_dir = "batch_processing_results_MIR1k"
    ...
    # For MIR1k
    for file in os.listdir(midi_base_dir):
        if file.endswith(".mid"):
            midi_file = os.path.join(midi_base_dir, file)
            song_name = file.split(".mid")[0]
            midi_files.append((song_name, midi_file))
    ...
    for song_name, input_melody_path in midi_files:
        try:
            ...
            beat_file_path = os.path.join(beat_base_dir, song_name, song_name+"_beat_times.txt")
            beat_times = None
            estimated_bpm = None
            ...
            if USE_BEAT_TIMES and os.path.exists(beat_file_path):
                ...
                print("input_melody_path", input_melody_path)
                ...
                for i, track in enumerate(score.tracks):
                    if track.notes:
                        score.tracks = [track]
                        break
                print("processed_melody_path", processed_melody_path)
