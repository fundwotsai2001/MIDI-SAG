###############################################################################
# ── User config ──────────────────────────────────────────────────────────────
VOCAL_AUDIO_PATH="./example_input/too_much.wav"
...
declare -A STRUCTURE_TAG_PROMPTS=(
    [intro]="Calming piano and soft acoustic guitar open gently, reflective and melancholic, with subtle bass guitar and light drums"
    [verse]="Melancholic acoustic guitar and piano with warm bass guitar, steady drums, and a reflective, romantic mood"
    [chorus]="Energetic uplifting rock with driving drums, electric guitar riffs, bass guitar, and a happy emotional release"
    [bridge]="Reflective jazz-influenced passage with piano, acoustic guitar, bass, and calming percussion"
    [outro]="Calming piano and acoustic guitar fade slowly, melancholic yet romantic, with soft bass and gentle drums"
    [break]="Minimal instrumental pop break with sparse drums, cool electronic textures, and light bass"
    [inst]="Instrumental pop section with piano, electric guitar, bass guitar, and full drums, uplifting and energetic"
    [solo]="Expressive electric guitar solo over driving drums and bass guitar, energetic, cool, and rock-inspired"
)
...
STRUCTURE_STARTS=( 0.0 20.88 51.6 68.88 99.61 113.03 153.35 184.07 197.52 )
STRUCTURE_TAGS=(   intro   verse   chorus verse chorus inst verse chorus outro)
###############################################################################
